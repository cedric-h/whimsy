...
const load = () => {
  return Promise.all([
    ...
    import(/* webpackChunkName: "codemirror-base" */ "codemirror/mode/python/python.js"),
    import(/* webpackChunkName: "codemirror-base" */ "codemirror/mode/htmlmixed/htmlmixed.js"),
    import(/* webpackChunkName: "codemirror-base" */ "codemirror/addon/lint/lint.js"),
    import(/* webpackChunkName: "codemirror-base" */ "codemirror/addon/selection/active-line.js"),
...
const start = app => {
  return load().then(CodeMirror => {
    	CodeMirror.registerHelper("lint", "python", (text, options, instance) => {
